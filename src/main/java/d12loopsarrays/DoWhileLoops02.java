...
*/
        ...
        do {
            ...
            String passwoed = input.next();

            if (userName.equals("admin") && passwoed.equals("pwd123")) {
                System.out.println("Hesabiniza hosgeldiniz..");
                break;
            }
            counter++;
            if (counter < 4) {
                System.out.println("Kullanıcı adı veya şifre yanlış. Kalan giriş hakkınız: " + counter);
            }
