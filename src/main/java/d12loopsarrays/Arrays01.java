...
public class Arrays01 {
    ...
    */
        ...
        String[] stdNames1 = new String[3];//javada yaygin kullanimi bu
        //String StdNames2[] = new String[4];// C style

        //System.out.println(stdNames1); // Arraylar dogrudan yazdirilamaz
        ...
        System.out.println(names[1]);//Ayse Hanim, Arrayin tamamini gormeden icindeki bir veriyi gorebiliriz
        ...
        //2.Yol for each loop -(enhamced - gelistirilmis loop)
