...
public class Maps04 {
    public static void main(String[] args) {
        ...
        */
        ...
        Hashtable<String, Integer> studentGrade = new Hashtable<>();
        studentGrade.put("Selma",70);
        studentGrade.put("Tuba",75);
        studentGrade.put("Ibrahin",85);
        studentGrade.put("Sefa",87);

        //studentGrade.put(null,50); //Hata!
        //studentGrade.put("Ahmet", null); //Hata!

        HashMap<String,Integer> stdAges=new HashMap<>();
        stdAges.put("Ali",18);
        stdAges.put("Ahmet",41);
        stdAges.put(null,41);
        stdAges.put(null,39); //Kabul eder ama ustune yazar;
        stdAges.put("a",null);
        stdAges.put("b",null);
        ...
        //Elemana erisme
        System.out.println("Elmanin stok miktari: " + stock.get("Elma"));

        //Guncelleme veya ekleme
        stock.putIfAbsent("Cilek",30); //Cilek depomda yoksa ekle
        ...
        countryPopulation.put("Turkiye",8300000);
        countryPopulation.put("Netherland",1800000);
        //countryPopulation.put(null,1800000); HATA!
        ...
        */
        ...
        for (Map.Entry<String,Integer> entry : lhm.entrySet()){ //Map'i donguye sokmak icin entrySet methodu kullanilir
            System.out.println(entry.getKey() + "-->" + entry.getValue()); //Ali-->25
                                                                           //Can-->18
                                                                           //Mehmet-->30 /insetrion order 'ekleme sirasi'
