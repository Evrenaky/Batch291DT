...
public class Arrays04 {
    public static void main(String[] args) {
        ...
        int firstIndex = 0; //index'lere yukleme yaptikca bunu 1 arttiracagiz

        for (int w : arr) {

            if (w != 0) {
               newArr[firstIndex] = w; // bos array'in ilk index'ine 0 olmayan sayiyi yukledik
                firstIndex++;// ilk index'e yukleme yapildigi icin,
                // bir sonraki sifir harici sayi ilk indexé yuklenmesin diye 1 arttirdik.
            }
