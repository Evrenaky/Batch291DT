...
public class Lambda05 {
    public static void main(String[] args) {
        ...
        //printElementsLengthLessThanFiveUniqueLowerCase(myList);//elif
    ...
    //example 2: Write a method that prints all unique (non-repetitive)
    // elements with less than 5 characters in a List<String> to the console.
    ...
    //Example 3:Write a method that converts all elements with more than 5 characters in a List<String>
