...
public class Sb02 {
    public static void main(String[] args) {
        ...
        System.out.println(sb2.capacity());//16 default kapasitedir ama degistirilebilir.
        ...
        StringBuilder sb3 = new StringBuilder(3); //Constructor kismina int yaziliersa capacity sayilir
        ...
        System.out.println(sb4.capacity()); //34 //44  32'yo astigi icin lenght kadar yer acti
