...
public class Variables01 {
    ...
    public static void main(String[] args){
         ...
         //Java bu satiri okumaz. Kendimizie veya baskasina aciklamadir
        ...
        //countryPopulation.soultv
        //System.out.println("countryPopulation = " + countryPopulation);

        System.out.println("Turkiye Nufusu: " + countryPopulation); //Turkiye nufusu; 84344345
