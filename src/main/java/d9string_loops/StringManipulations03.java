...
public class StringManipulations03 {
    public static void main(String[] args) {
        ...
        //Not:
        // isEmpty() metodu sadece hicligi kontrol eder (true verir).
        ...
        //3- Başında ve sonunda boşluk olmamalıdır.
        boolean third = pwd.trim().equals(pwd); // .equals esit olup olmadigini kontrol eder ==
        ...
        if (second) {
            System.out.println("Parolada bos birakilmamali ve bosluk harici karakterlerde bulunmalidir");
        }

        if (!third) {
            System.out.println("Basinda ve sonunda bosluk olamaz");
        }
