...
public class StringManupilations04 {
...
Java'da iki ana bellek alanı vardır: Heap (yığın) ve Stack (yığın).
    ...
    heap belleğinde bulunan nesnelere işaret eder.Bir ülkenin navigasyon sistemi gibi
...
*/
        ...
        //String str1 = "merhaba";
        //String str5 = "merhaba";
        String str1 = new String("Merhaba"); //new String herzaman yeni bir alan acar
        String str2 = new String("Merhaba");
        String str3 = str1;

        System.out.println(str1==str2);//false cunku == kullanirsaniz, iki String'i karsilastirirken adreslerini kontrol eder.
        System.out.println(str1.equals(str2));//true  equals() methodu ise iki String'i karsilastirirken sadece degerlerine bakar
        System.out.println(str1==str3);//true iki String'i karsilastirirken adreslerini kontrol eder.
