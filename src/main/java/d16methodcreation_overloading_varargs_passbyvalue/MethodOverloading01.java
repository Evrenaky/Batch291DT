...
public class MethodOverloading01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //------------------
        String s = "Java";
        //s.substring() => Bu methodu bir String objesi uzerinden cagiririz.Boyle methodlara non-static denir

        //Math.min() ==> Bu methodu direkt class adiyla cagirdik boylr methodlara static denir
