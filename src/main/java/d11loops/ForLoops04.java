...
public class ForLoops04 {
    public static void main(String[] args) {
      ...
      X X X X X    */
        ...
        System.out.println("Satir sayinizi giriniz giriniz");
        ...
        for (int i = 1; i <= row ; i++) {
            ...
            System.out.println();//ustteki print yan yana yazdirir pointer'i bir alta aldik
        }

        /*Odev : Asagidaki sekli for-loop kullanarak çizdiriniz.
        Homework: Draw the following figure using for-loop. (icteki dongude sabit bir sayi yazmiyacak)
