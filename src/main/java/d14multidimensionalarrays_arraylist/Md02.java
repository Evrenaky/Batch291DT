...
public class Md02 {
    public static void main(String[] args) {
        ...
        int totalNunmberElement = 0;
        for (int[] w : numbers) {
            totalNunmberElement = totalNunmberElement + w.length;
        }
        System.out.println(totalNunmberElement); //5

        //2.adim: Tek boyutlu Array’i, iki boyutlu Array’in eleman sayisini kullanarak olusturalim
        int[] newArr = new int[totalNunmberElement];
        ...
        // ODEV : 3 boyutlu bir array olusturmaya calisin
