...
public class ArrayList01 {
    public static void main(String[] args) {
        ...
        */
        ...
        ages.add(1, 28);
        System.out.println(ages); //[9, 28, 12, 5] oteleme yapti
        ...
        ages.addAll(newAges);
        System.out.println(ages);//[9, 28, 12, 7, 5, 11, 1, 2, 3] indeksleri birlestirdik

        ages.addAll(0, newAges);
        System.out.println(ages);//[1, 2, 3, 9, 28, 12, 7, 5, 11, 1, 2, 3] belirtilen indekse ekledik

        //---------------------- .get getir .set degistir
        //size() metodu, ArrayList’teki öğelerin sayısını döndürür. (int return eder)
        int totalElemnt = ages.size();
        System.out.println(totalElemnt); //12 lenght listlerde size olur
       ...
       Integer a = ages.set(1, 25);
        System.out.println(a); //2 , eski degeri yani degisterecegi degeri yazdirir
