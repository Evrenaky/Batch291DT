...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        List<String> list2 = new ArrayList<>(); //Genel kullanim
        // List<String> list3 = new List<String>(); //HATA, interface'lerden object uretilemez
        ...
        LinkedList<String> linkedList = new LinkedList<>(Arrays.asList("Eleman1", "Eleman2", "Eleman3"));//cok kullanilmaz kalabaliklastiriyor
        //System.out.println(linkedList); // [Eleman1, Eleman2, Eleman3]

        LinkedList<String> linkedList2 = new LinkedList<>(List.of("Eleman1", "Eleman2", "Eleman3"));//daha yeni
        ...
        /*List<String> immutableList = List.of("Eleman1","Eleman2","Eleman3");// eleman ekleyemez, çıkaramaz
        immutableList.add("Serkan");
        System.out.println(immutableList); //UnsupportedOperationException hatası fırlatır.*/
        //--------------------------------------------
