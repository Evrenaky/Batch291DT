...
public class Sets01 {
    public static void main(String[] args) {
        ...
        String a = "Ali can";
        System.out.println(a.hashCode());//hashcode'lar benzersiz degildir
        //----------------------
        ...
        hs.add("Kerem");
        System.out.println(hs);//[Kerem, Sinan, Tuba, Onur] hata vermez uzerine yazar
        ...
        System.out.println(ts);//[A, G, R, U, Z] - natural order - sayilarda kucukten buyuge, -A'dan Zýe
