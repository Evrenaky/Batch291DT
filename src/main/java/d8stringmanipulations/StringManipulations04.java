...
public class StringManipulations04 {
    public static void main(String[] args) {
        ...
        char first = name.trim().toUpperCase().charAt(0);//trim basindaki ve sonundaki bosluklari siler
        //System.out.println("first = " + first);//A

        char last = name.trim().toUpperCase().split(" ")[1].charAt(0);//split iki ismi bosluktan ikiye boldu 0 ve 1
        //System.out.println("last = " + last);//C
        System.out.println(""+first+last); //"" ile charin toplama islemini iptal ettik
        //  \\s+ ifadesi, bir veya daha fazla ardışık boşluk karakterini ifade eder.
        //  eger iki isim aradinda birden fazla bosluk olsaydi bu sekilde bolebiliriz
