    ...
    public static void main(String[] args) {
     ...
     /*
      ...
      Bu kisim da [] kullanilmaz. Buyuk harfler olumsuz anlama gelir
        ...
        Rakamlar haric         : \\D
        `\\s+` ifadesi, bir veya daha fazla boşluk karakterini (space, tab gibi) temsil eden
         bir regex ifadesidir.
        Bu sayede, cümledeki birden fazla boşluk bir arada ele alınır ve bu boşluklarla
        kelimeler arasında ayırma işlemi yapılır.
        */
        //------------------------
