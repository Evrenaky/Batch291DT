...
public class Car {
    ...
    public void stop() {
        System.out.println(brand + " Abs ile Guvenli bir mesafede durur");
    }
    ...
    *****Method ile Constructor arasindaki fark nedir? Interview Sorusu
    ...
    d)Method isimleri kucuk harfle baslar, constructor isimleri ise class ismi ile ayni oldugu icin buyuk harfle baslar
    ...
    a- Parametresiz (default)
        ...
        c) constractor static olmaz
    b- Parametreli*/

    public Car(String brand, String model, int year, boolean hybrid) {
        this.brand = brand; //Bu class'taki brand degerini kulllanma ben sana parametre olarak gonderecegim
        this.model = model;
        this.year = year;
        this.hybrid = hybrid;
    }
